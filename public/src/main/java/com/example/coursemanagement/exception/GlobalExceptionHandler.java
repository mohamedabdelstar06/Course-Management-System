...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<java.util.Map<String, Object>> handleRegistrationWindow(RegistrationWindowException ex) {
        log.warn("Registration window closed: {}", ex.getMessage());
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
